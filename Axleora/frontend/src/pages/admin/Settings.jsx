    ...
    <div className="account-layout">
      ...
      <div className="account-forms">
        ...
        <form className="admin-panel settings-form" onSubmit={changePassword}>
          ...
          <div className="form-grid compact-grid">
            <label>New password<input required minLength="8" type="password" value={password.newPassword} onChange={e => setPassword({ ...password, newPassword: e.target.value })}/></label>
            <label>Confirm new password<input required type="password" value={password.confirm} onChange={e => setPassword({ ...password, confirm: e.target.value })}/></label>
          </div>
